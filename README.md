...
Aplicación encargada de gestionar las sesiones deportivas de los usuarios.
...
1. `pipenv shell`
2. `pipenv install`
3. `FLASK_APP=./src/main.py flask run -h 0.0.0.0 -p 3005`
...
- `FLASK_APP=./src/main.py flask run -h 0.0.0.0 -p 3005 --reload`
...
1. `docker build . -t sport-app-gestor-sesion-deportiva`
2. `docker run -p 3005:3005 --name gestor-sesion-deportiva --env-file .env sport-app-gestor-sesion-deportiva`
